...
class SensorReading(models.Model):
    ...
    rtc_timestamp_date = models.CharField(max_length=255)
    rtc_timestamp_time = models.CharField(max_length=255)
    test_time_date = models.CharField(max_length=255)
    test_time_time = models.CharField(max_length=255)
    test_duration_hmi = models.CharField(max_length=255)
    bt_current_and_direction = models.CharField(max_length=255)
    adapter_connection = models.CharField(max_length=255)
    connected_pd_name = models.CharField(max_length=255)
    sensor_error_code1 = models.CharField(max_length=255)
    sensor_error_code2 = models.CharField(max_length=255)
    sensor_error_code3 = models.CharField(max_length=255)
    exception_name = models.CharField(max_length=255)
    exception_details = models.CharField(max_length=255)
    exception_code = models.CharField(max_length=255)
    exception_date = models.CharField(max_length=255)
    exception_time = models.CharField(max_length=255)
    exception_location = models.CharField(max_length=255)
    touch_date = models.CharField(max_length=255)
    touch_time = models.CharField(max_length=255)
    touch_location = models.CharField(max_length=255)
